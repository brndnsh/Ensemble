export const analyzerModalHtml = `
<div id="analyzerOverlay" class="modal-overlay">
    <div class="modal-content analyzer-modal settings-content">
        <button class="close-modal-btn" id="closeAnalyzerBtn" aria-label="Close Analyzer">✕</button>
